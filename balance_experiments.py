    ...
    for i_cv in range(cv_count):
        ...
        for i, (dataset_name, adata_train_i) in enumerate(adatas.items()):
            ...
            create_and_train_vae_model(adata_train_i, 
                                        ...
                                        verbose=False,
                                        **model_params)
            r2_valid, _ = evaluate_r2_custom(adata_train_i, valid_ctrl, valid_stim, params_filename, **model_params)
            r2_test, _  = evaluate_r2_custom(adata_train_i,  test_ctrl,  test_stim, params_filename, **model_params)
    ...
    for i_cv in range(cv_count):
        ...
        for i, adata_train_i in enumerate(adatas):
            ...
            create_and_train_vae_model(adata_train_i, 
                                       ...
                                       verbose=False,
                                       **model_params)
            r2_valid, _ = evaluate_r2_custom(adata_train_i.concatenate(valid_ctrl), valid_ctrl, valid_stim, params_filename, **model_params)
            r2_test, _  = evaluate_r2_custom(adata_train_i.concatenate(test_ctrl),  test_ctrl,  test_stim, params_filename, **model_params)
